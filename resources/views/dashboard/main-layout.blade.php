...
<html lang="en">
	...
	<head>
		...
		<link href="{{asset('metronic_assets/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" />
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
								...
								<div class="d-flex align-items-stretch flex-shrink-0">
									...
									<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
										...
										<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											{{-- <img src="{{asset('metronic_assets/media/avatars/300-1.jpg')}}" alt="user" /> --}}
											{{ Auth::user()->name }}
										</div>
					...
					<!--begin::Content-->
					<div class="d-flex bg-secondary flex-column flex-column-fluid" id="kt_content">
						<div id="kt_content_container" class="px-1 mx-0" style="">
							@yield('content')
						</div>
					</div>
					<!--end::Content-->
